...
from kwelivote_app.models import Voter, KeyPerson, Candidate, ResultsCount
from django.utils import timezone

class Command(BaseCommand):
    help = 'Populate the database with test data for Voter, KeyPerson, Candidate'
